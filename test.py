...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Soft Parameter Sharing Model for Cross-Problem Generalization in Vehicle Routing Problems")
    # env_params
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="SPSM")
    ...
    # tester_params
    parser.add_argument('--checkpoint', type=str, default="./checkpoint/SPSM50epoch-5000.pt", help="load pretrained model to evaluate")
